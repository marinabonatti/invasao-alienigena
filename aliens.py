...
class Aliens(Sprite):
    ...
    def __init__(self, jogo):
        """Acessa os atributos da classe Sprite e do argumento jogo.
        Também cria o image e o rect da classe."""
        super().__init__()
        self.tela = jogo.tela
    ...
    def _verificar_colisao_aliens_lasers(self):
        ...
        if colisoes:
            ...
            if len(self.jogo.aliens) == 0:
                ...
                self.jogo.placar._preparar_nivel()
                self.jogo.configuracoes.aumentar_velocidade()
            self.jogo.placar._preparar_pontuacao()
